...
struct PieChartRows: View {
    ...
    var body: some View {
        VStack{
            Color(red: 21 / 255, green: 24 / 255, blue: 30 / 255, opacity: 1.0).edgesIgnoringSafeArea(.all)
            ForEach(0..<self.values.count){ i in
                HStack {
...
struct PieChartView_Previews: PreviewProvider {
    static var previews: some View {
        PieChartView(values: [1400, 800,], names: ["Rent", "Transport", "Education"], formatter: {value in String(format: "$%.2f", value)})
    }
}
